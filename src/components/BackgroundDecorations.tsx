  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
      ...
      <div 
        ...
        style={{ backgroundColor: 'hsl(340 82% 88% / 0.3)', animationDelay: '0s' }} 
      />
      <div 
        className="absolute top-40 right-[8%] w-6 h-6 rounded-full animate-float" 
        style={{ backgroundColor: 'hsl(199 89% 85% / 0.3)', animationDelay: '1s' }} 
      />
      <div 
        className="absolute top-[60%] left-[3%] w-10 h-10 rounded-full animate-float" 
        style={{ backgroundColor: 'hsl(45 93% 85% / 0.3)', animationDelay: '2s' }} 
      />
      <div 
        className="absolute top-[80%] right-[5%] w-7 h-7 rounded-full animate-float" 
        style={{ backgroundColor: 'hsl(142 52% 80% / 0.3)', animationDelay: '0.5s' }} 
      />
      
      {/* Bintang-bintang */}
      <svg 
        className="absolute top-[15%] right-[12%] w-6 h-6 animate-bounce-gentle" 
        style={{ color: 'hsl(45 93% 85% / 0.5)', animationDelay: '0.3s' }} 
        viewBox="0 0 24 24" 
        fill="currentColor"
      >
      ...
      <svg 
        ...
        style={{ color: 'hsl(270 67% 85% / 0.5)', animationDelay: '1.5s' }} 
        viewBox="0 0 24 24" 
        fill="currentColor"
      >
        <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
      ...
      <svg 
        ...
        style={{ color: 'hsl(340 82% 88% / 0.45)', animationDelay: '1.8s' }} 
        viewBox="0 0 24 24" 
        fill="currentColor"
      >
      ...
      <div 
        ...
        style={{ border: '2px solid hsl(142 52% 80% / 0.4)', animationDelay: '0.6s' }} 
      />
    </div>
  );
};
